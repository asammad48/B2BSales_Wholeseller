    ...
    <div className="min-h-screen bg-[var(--bg-app)] p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-1 xl:grid-cols-[1.1fr_0.9fr] gap-6">
          ...
          <div className="bg-[var(--bg-surface)] rounded-[24px] border border-[var(--border-subtle)] p-6 shadow-sm h-fit">
            <div className="mb-5">
            ...
            <div className="mt-6 rounded-2xl bg-[var(--bg-surface-variant)] p-4">
              <p className="text-xs font-semibold uppercase tracking-widest text-gray-500">Available currencies</p>
              <div className="mt-3 flex flex-wrap gap-2">
                {currencyOptions.map((option) => (
                  <span key={option.value} className="inline-flex items-center rounded-full bg-[var(--bg-surface)] px-3 py-1 text-xs text-gray-600 border border-[var(--border-subtle)]">
                    {option.label}
                  </span>
                ))}
              </div>
