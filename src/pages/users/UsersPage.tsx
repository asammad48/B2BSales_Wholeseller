    ...
    <div className="min-h-screen bg-[var(--bg-app)] p-6">
      <div className="max-w-7xl mx-auto">
        <PageHeader
          ...
          actions={
            <button onClick={openCreateModal} className="bg-[var(--color-primary)] text-white px-5 py-2.5 rounded-xl flex items-center gap-2 text-sm font-medium hover:bg-[var(--color-primary-hover)]">
